# !/usr/bin/env python
# -*- coding: utf-8 -*-
# @Time    : 2021/4/15 22:17
# @Author  : Zheng Xingtao
# @File    : z_n_12_划分单项链表.py
...
1、将链表调整为左部分都是值小于 pivot 的节点，中间部分都是值等于pivot的节点，右部分都是值大于 pivot的节点。
2、除这个要求外，对调整后的节点顺序没有更多的要求。
...
2、在满足原问题要求的同时，左部分节点从左到右为0、1。
在原链表中也是先出现0，后出现1；中间部分在本例中为空，不再讨论
